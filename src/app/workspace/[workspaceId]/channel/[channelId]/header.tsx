...
import { useRemoveChannel } from "@/features/channels/api/use-remove-chanel";
                    ...
                    <div className="px-4 pb-4 flex flex-col gap-y-2">
                        <Dialog open={editOpen} onOpenChange={handleEditOpen}>
                            ...
                            <DialogContent className="p-0 bg-gray-50 overflow-hidden">
                                ...
                                <form onSubmit={handleSubmit} className="px-4 pb-4 flex flex-col gap-y-4">
                                    <Input
                                        value={value}
                                    ...
                                    <DialogFooter className="flex justify-end pt-2">
                                        ...
                                        <Button
                                            disabled={isUpdatingChannel}
                                            className="ml-2 bg-gray-900 text-white hover:bg-gray-800"
                                        >
                                            Save
                                        </Button>
                                    </DialogFooter>
